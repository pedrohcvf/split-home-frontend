        ...
        {screen === "login" && (
          <div>
            <div className="mb-4">
              ...
              <input type="email" placeholder="seu@email.com" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#2D6A4F]" />
            </div>
            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Senha</label>
              <input type="password" placeholder="••••••••" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#2D6A4F]" />
            </div>
            <button className="w-full bg-[#2D6A4F] text-white rounded-xl py-2.5 text-sm font-medium cursor-pointer hover:bg-[#1B4332] transition-all mb-4">
              Entrar
            </button>
        ...
        {screen === "register" && (
          <div>
            <div className="mb-4">
              ...
              <input type="text" placeholder="Seu nome completo" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#2D6A4F]" />
            </div>
            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Email</label>
              <input type="email" placeholder="seu@email.com" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#2D6A4F]" />
            ...
            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Senha</label>
              <input type="password" placeholder="mínimo 8 caracteres" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#2D6A4F]" />
            </div>
            <button className="w-full bg-[#2D6A4F] text-white rounded-xl py-2.5 text-sm font-medium cursor-pointer hover:bg-[#1B4332] transition-all">
              Criar conta
            </button>
          </div>
        )}
        ...
        {screen === "join" && (
          <div>
            ...
            <div className="mb-4">
              ...
              <input type="text" placeholder="ex: AB12-XY99" className="w-full bg-[#F7F9F7] border border-[#c8e6c9] rounded-xl px-3 py-2.5 text-sm text-center tracking-widest outline-none focus:border-[#2D6A4F] font-medium" />
            </div>
            <button className="w-full bg-[#2D6A4F] text-white rounded-xl py-2.5 text-sm font-medium cursor-pointer hover:bg-[#1B4332] transition-all">
              Entrar na split
            </button>
